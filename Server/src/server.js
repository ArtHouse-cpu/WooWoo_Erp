...
import spaceBookingRoutes from './routes/spaceBooking.route.js';
import foodRoutes from './routes/food.route.js';
import catalogueRoutes from './routes/catalogue.route.js';
...
app.use('/space-bookings', spaceBookingRoutes);
