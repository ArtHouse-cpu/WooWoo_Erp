...
function InputField({
  ...
  return (
    <div>
      <label htmlFor={keyName} className="mb-1.5 block text-sm font-medium text-slate-700">
            ...
            <div className="space-y-8">
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <InputField label="Mobile" value={form.mobile} keyName="mobile" onValueChange={update} placeholder="Primary mobile" required maxLength={10} />
                  <InputField label="Email" value={form.email} keyName="email" onValueChange={update} type="email" placeholder="Email address" />
                  <InputField label="Company Name" value={form.companyName} keyName="companyName" onValueChange={update} placeholder="Registered business name" />
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <InputField label="Aadhar Number" value={form.adharNumber} keyName="adharNumber" onValueChange={update} placeholder="Aadhar details" maxLength={12} />
                  <InputField label="GSTIN" value={form.gstin} keyName="gstin" onValueChange={update} placeholder="GST Number" />
                </div>
              </section>
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <InputField label="Bank Name" value={form.bankName} keyName="bankName" onValueChange={update} placeholder="e.g. HDFC Bank" />
                  <InputField label="Account Number" value={form.accountNumber} keyName="accountNumber" onValueChange={update} placeholder="Bank Ac No." maxLength={20} />
                  <InputField label="IFSC Code" value={form.IFSCcode} keyName="IFSCcode" onValueChange={update} placeholder="Branch IFSC" maxLength={11} />
                  <InputField label="Branch Name" value={form.branchName} keyName="branchName" onValueChange={update} placeholder="e.g. MG Road Branch" />
                  <InputField label="UPI ID" value={form.UPIID} keyName="UPIID" onValueChange={update} placeholder="e.g. user@bank" />
                </div>
              </section>
              ...
              <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                  <div className="md:col-span-2 lg:col-span-3">
                    <InputField label="Full Address" value={form.address} keyName="address" onValueChange={update} placeholder="Street layout, building, area" />
                  </div>
                  <InputField label="Pincode" value={form.pincode} keyName="pincode" onValueChange={update} placeholder="Postal code" maxLength={6} />
                  <InputField label="City" value={form.city} keyName="city" onValueChange={update} placeholder="e.g. Mumbai" />
                  <InputField label="State" value={form.state} keyName="state" onValueChange={update} placeholder="e.g. Maharashtra" />
